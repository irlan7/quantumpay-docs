 ...
 * Proof of Stake (PoS) Layer: Responsible for validator selection and network security. Participants lock (stake) QTM tokens to earn the right to propose and vote on blocks. This eliminates the energy waste associated with Proof of Work.
 ...
 * Total Supply: 210,000,000 QTM.
 * Staking Utility: QTM tokens are required to participate in the PoS consensus. Validators receive rewards for securing the network and processing transactions.
